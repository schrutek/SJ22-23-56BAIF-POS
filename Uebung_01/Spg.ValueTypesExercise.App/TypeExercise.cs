...
namespace Spg.ValueTypesExercise.App
{
    public class TypeExercise
    {
        ...
        public double BerechneSchuelerProKlasse(int schuelerGesamt, int klassenGesamt)
        {
            ...
            Console.WriteLine(((double)schuelerGesamt / klassenGesamt).ToString("0.00"));

            //return schuelerGesamt / klassenGesamt;              // 16 (int)
            return (double)schuelerGesamt / klassenGesamt;      // 16.66666666668
        }
    ...
    public class Programm
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("BerechneAchtel(120):               " + typeExercise.BerechneAchtel(999999999999));
